...
public abstract class AbstractCodesEndpointIntegrationTest
  ...
  @Test
  @DisplayName("Get silv technique codes without auth should return 403")
  void getSilvTechniqueCodes_noAuth_shouldReturn403() throws Exception {
    // When/Then
    mockMvc.perform(get("/api/codes/silv-technique")).andExpect(status().isForbidden());
  }
