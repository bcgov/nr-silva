...
public abstract class AbstractOpeningStandardUnitHistoryServiceTest<T extends OpeningStandardUnitHistoryService> {

  @Mock
  protected OpeningRepository openingRepository;

  @Mock
  protected SilvicultureCommentRepository commentRepository;
