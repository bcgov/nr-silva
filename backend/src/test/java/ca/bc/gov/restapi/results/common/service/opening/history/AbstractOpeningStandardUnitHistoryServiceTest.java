...
@DisplayName("Unit Test | Opening Standard Unit History Service | Contract")
public abstract class AbstractOpeningStandardUnitHistoryServiceTest<
    T extends OpeningStandardUnitHistoryService> {

  @Mock protected OpeningRepository<?> openingRepository;

  @Mock protected SilvicultureCommentRepository commentRepository;

  protected OpeningStandardUnitHistoryService openingStandardUnitHistoryService;
  ...
  @BeforeEach
  void setup() {
    openingStandardUnitHistoryService = createService(openingRepository, commentRepository);
  }
  ...
  void getStandardUnitHistoryDetails_noDetails_WithComparison_shouldReturnEmptyList() {
    ...
    List<OpeningStockingHistoryWithComparisonDto> result =
        openingStandardUnitHistoryService.getStandardUnitHistoryDetailsWithComparison(
            openingId, stockingEventHistoryId);
  ...
  void getStandardUnitOverviewHistoryList_returnsCorrectOverviewList() {
    ...
    OpeningStockingHistoryProjection amendedProjection =
        mock(OpeningStockingHistoryProjection.class);
    ...
    OpeningStockingHistoryProjection correctionProjection =
        mock(OpeningStockingHistoryProjection.class);
    ...
    Assertions.assertTrue(
        amendedDto.eventTimestamp().isAfter(LocalDateTime.of(2025, 7, 3, 11, 45)));
    ...
    Assertions.assertTrue(
        correctionDto.eventTimestamp().isBefore(LocalDateTime.of(2025, 7, 3, 11, 30)));
  ...
  @Test
  @DisplayName(
      "getStandardUnitHistoryDetails returns details for creating new stocking standard unit"
          + " layers")
  void getStandardUnitHistoryDetails_creatingLayers_shouldReturnCorrectDetailsWithComparison() {
    ...
    OpeningStockingHistoryDetailsWithComparisonProjection suDetailsProjection =
        mock(OpeningStockingHistoryDetailsWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerWithComparisonProjection layerProjection =
        mock(OpeningStockingHistoryLayerWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    when(openingRepository
            .getOpeningStandardUnitHistoryDetailsWithComparisonByOpeningIdAndHistoryId(
                openingId, stockingEventHistoryId))
        .thenReturn(List.of(suDetailsProjection));
    when(openingRepository
            .getOpeningStandardUnitHistoryLayerDetailsWithComparisonByOpeningIdAndHistoryId(
                openingId, stockingEventHistoryId))
    ...
    when(openingRepository
            .getOpeningStandardUnitHistoryLayerSpeciesDetailsWithComparisonByOpeningIdAndHistoryId(
                openingId, stockingEventHistoryId))
        .thenReturn(List.of(speciesProjection));
  ...
  void
      getStandardUnitHistoryDetails_multiLayerConversion_shouldReturnCorrectDetailsWithComparison() {
    // Given
    Long openingId = 123L;
    Long stockingEventHistoryId = 1L;
    ...
    OpeningStockingHistoryDetailsWithComparisonProjection suDetailsProjection1 =
        mock(OpeningStockingHistoryDetailsWithComparisonProjection.class);
    ...
    OpeningStockingHistoryDetailsWithComparisonProjection suDetailsProjection2 =
        mock(OpeningStockingHistoryDetailsWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerWithComparisonProjection layerProjection1 =
        mock(OpeningStockingHistoryLayerWithComparisonProjection.class);
    ...
    // SU2: Unchanged layer
    OpeningStockingHistoryLayerWithComparisonProjection layerProjection2 =
        mock(OpeningStockingHistoryLayerWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerWithComparisonProjection layerProjection3 =
        mock(OpeningStockingHistoryLayerWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerWithComparisonProjection layerProjection4 =
        mock(OpeningStockingHistoryLayerWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerWithComparisonProjection layerProjection5 =
        mock(OpeningStockingHistoryLayerWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection1 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection2 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection3 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection4 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection5 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection6 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection7 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection8 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection9 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    OpeningStockingHistoryLayerSpeciesWithComparisonProjection speciesProjection10 =
        mock(OpeningStockingHistoryLayerSpeciesWithComparisonProjection.class);
    ...
    when(openingRepository
            .getOpeningStandardUnitHistoryDetailsWithComparisonByOpeningIdAndHistoryId(
                openingId, stockingEventHistoryId))
        .thenReturn(List.of(suDetailsProjection1, suDetailsProjection2));
    when(openingRepository
            .getOpeningStandardUnitHistoryLayerDetailsWithComparisonByOpeningIdAndHistoryId(
                openingId, stockingEventHistoryId))
        .thenReturn(
    ...
    Assertions.assertTrue(
        Boolean.parseBoolean(standardUnit1.standardUnit().oldVarianceIndicator()));
    Assertions.assertTrue(
        Boolean.parseBoolean(standardUnit1.standardUnit().newVarianceIndicator()));
    Assertions.assertFalse(
        Boolean.parseBoolean(standardUnit1.standardUnit().oldRegenObligationIndicator()));
    Assertions.assertFalse(
        Boolean.parseBoolean(standardUnit1.standardUnit().newRegenObligationIndicator()));
    Assertions.assertEquals(
        Integer.valueOf(1), standardUnit1.standardUnit().oldNoRegenEarlyOffsetYears());
    Assertions.assertEquals(
        Integer.valueOf(1), standardUnit1.standardUnit().newNoRegenEarlyOffsetYears());
    Assertions.assertEquals(
        Integer.valueOf(2), standardUnit1.standardUnit().oldNoRegenLateOffsetYears());
    Assertions.assertEquals(
        Integer.valueOf(2), standardUnit1.standardUnit().newNoRegenLateOffsetYears());
    ...
    var tremAsp =
        originalLayer.preferredSpecies().stream()
    ...
    var grandFir =
        originalLayer.acceptableSpecies().stream()
    ...
    Assertions.assertTrue(
        Boolean.parseBoolean(standardUnit2.standardUnit().oldVarianceIndicator()));
    Assertions.assertTrue(
        Boolean.parseBoolean(standardUnit2.standardUnit().newVarianceIndicator()));
    Assertions.assertTrue(
        Boolean.parseBoolean(standardUnit2.standardUnit().oldRegenObligationIndicator()));
    Assertions.assertTrue(
        Boolean.parseBoolean(standardUnit2.standardUnit().newRegenObligationIndicator()));
    ...
    Assertions.assertEquals(
        Integer.valueOf(11), standardUnit2.standardUnit().oldFreeGrowingEarlyOffsetYears());
    Assertions.assertEquals(
        Integer.valueOf(11), standardUnit2.standardUnit().newFreeGrowingEarlyOffsetYears());
    Assertions.assertEquals(
        Integer.valueOf(14), standardUnit2.standardUnit().oldFreeGrowingLateOffsetYears());
    Assertions.assertEquals(
        Integer.valueOf(14), standardUnit2.standardUnit().newFreeGrowingLateOffsetYears());
  ...
  void getOpeningStockingHistoryList_returnsCorrectStockingHistoryList() {
    ...
    OpeningStockingHistoryDetailsProjection detailsProjection =
        mock(OpeningStockingHistoryDetailsProjection.class);
    ...
    OpeningStockingSpeciesHistoryProjection preferredSpeciesProjection =
        mock(OpeningStockingSpeciesHistoryProjection.class);
    ...
    OpeningStockingSpeciesHistoryProjection acceptableSpeciesProjection =
        mock(OpeningStockingSpeciesHistoryProjection.class);
    ...
    when(openingRepository.getOpeningStockingHistoryDetailsByOpeningIdAndEventHistoryId(
            openingId, eventHistoryId))
        .thenReturn(List.of(detailsProjection));

    when(openingRepository.getOpeningStockingLayerHistoryByOpeningIdAndEventHistoryId(
            openingId, eventHistoryId, ssuId))
        .thenReturn(List.of(layerProjection));

    when(openingRepository.getOpeningStockingSpeciesHistoryByOpeningIdAndEventHistoryId(
            openingId, eventHistoryId, "Y", ssuId))
        .thenReturn(List.of(preferredSpeciesProjection));
    when(openingRepository.getOpeningStockingSpeciesHistoryByOpeningIdAndEventHistoryId(
            openingId, eventHistoryId, "N", ssuId))
    ...
    verify(openingRepository)
        .getOpeningStockingHistoryDetailsByOpeningIdAndEventHistoryId(openingId, eventHistoryId);
    verify(openingRepository)
