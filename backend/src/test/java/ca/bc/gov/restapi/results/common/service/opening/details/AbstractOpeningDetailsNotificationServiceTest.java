...
@DisplayName("Unit Test | Opening Details Notification Service | Contract")
public abstract class AbstractOpeningDetailsNotificationServiceTest<
    T extends OpeningDetailsNotificationService> {
  ...
  @BeforeEach
  void setup() {
    openingDetailsNotificationService = createService(openingRepository);
  }
  ...
  void getNotifications_validMilestoneTypeCodes_shouldReturnNotifications() {
    ...
    OpeningStockingNotificationProjection projection1 =
        mock(OpeningStockingNotificationProjection.class);
    when(projection1.getNotificationType())
        .thenReturn(OpeningDetailsNotificationStatusEnum.ERROR.toString());
    when(projection1.getSilvMilestoneTypeCode()).thenReturn("FG");
    when(projection1.getStandardsUnitId()).thenReturn("A");

    OpeningStockingNotificationProjection projection2 =
        mock(OpeningStockingNotificationProjection.class);
    when(projection2.getNotificationType())
        .thenReturn(OpeningDetailsNotificationStatusEnum.WARNING.toString());
    when(projection2.getSilvMilestoneTypeCode()).thenReturn("FG");
    when(projection2.getStandardsUnitId()).thenReturn("B");

    OpeningStockingNotificationProjection projection3 =
        mock(OpeningStockingNotificationProjection.class);
    when(projection3.getNotificationType())
        .thenReturn(OpeningDetailsNotificationStatusEnum.INFO.toString());
    when(projection3.getSilvMilestoneTypeCode()).thenReturn("RG");
    when(projection3.getStandardsUnitId()).thenReturn("C");

    OpeningStockingNotificationProjection projection4 =
        mock(OpeningStockingNotificationProjection.class);
    when(projection4.getNotificationType())
        .thenReturn(OpeningDetailsNotificationStatusEnum.WARNING.toString());
    ...
    List<OpeningDetailsNotificationDto> result =
        openingDetailsNotificationService.getNotifications(openingId);

    Assertions.assertEquals(4, result.size());

    Assertions.assertEquals(
        "Free Growing milestone is overdue for standard unit \"A\"", result.get(0).title());
    Assertions.assertEquals(
    ...
    Assertions.assertEquals(
        "Upcoming Regeneration milestone detected for standard unit \"D\"", result.get(1).title());
    Assertions.assertEquals(
        "Monitor progress closely to update your forest cover!", result.get(1).description());
    Assertions.assertEquals(OpeningDetailsNotificationStatusEnum.WARNING, result.get(1).status());

    Assertions.assertEquals(
        "Upcoming milestone detected for standard unit \"B\"", result.get(2).title());
    Assertions.assertEquals(
        "Monitor progress closely to declare your Free Growing in time!",
        result.get(2).description());
    Assertions.assertEquals(OpeningDetailsNotificationStatusEnum.WARNING, result.get(2).status());

    Assertions.assertEquals(
        "Regeneration milestone reminder for standard unit \"C\"", result.get(3).title());
  ...
  void getNotifications_multipleStandardUnits_shouldReturnCombinedNotification() {
    ...
    OpeningStockingNotificationProjection warningProjection1 =
        mock(OpeningStockingNotificationProjection.class);
    ...
    OpeningStockingNotificationProjection warningProjection2 =
        mock(OpeningStockingNotificationProjection.class);
    ...
    OpeningStockingNotificationProjection warningProjection1Regen =
        mock(OpeningStockingNotificationProjection.class);
    ...
    OpeningStockingNotificationProjection warningProjection2Regen =
        mock(OpeningStockingNotificationProjection.class);
    ...
    OpeningStockingNotificationProjection errorProjection1 =
        mock(OpeningStockingNotificationProjection.class);
    ...
    OpeningStockingNotificationProjection errorProjection2 =
        mock(OpeningStockingNotificationProjection.class);
    ...
    OpeningStockingNotificationProjection infoProjection1 =
        mock(OpeningStockingNotificationProjection.class);
    ...
    OpeningStockingNotificationProjection infoProjection2 =
        mock(OpeningStockingNotificationProjection.class);
    ...
    Assertions.assertEquals(
        "Free Growing milestone is overdue for standard unit \"B, D\"", result.get(0).title());
    Assertions.assertEquals(
        "Please contact your ministry representative as soon as possible!",
        result.get(0).description());
    Assertions.assertEquals(OpeningDetailsNotificationStatusEnum.ERROR, result.get(0).status());
    ...
    Assertions.assertEquals(
        "Upcoming Regeneration milestone detected for standard unit \"H, I\"",
        result.get(1).title());
    Assertions.assertEquals(
        "Monitor progress closely to update your forest cover!", result.get(1).description());
    Assertions.assertEquals(OpeningDetailsNotificationStatusEnum.WARNING, result.get(1).status());
    ...
    Assertions.assertEquals(
        "Upcoming milestone detected for standard unit \"A, C\"", result.get(2).title());
    Assertions.assertEquals(
        "Monitor progress closely to declare your Free Growing in time!",
        result.get(2).description());
    Assertions.assertEquals(OpeningDetailsNotificationStatusEnum.WARNING, result.get(2).status());
    ...
    Assertions.assertEquals(
        "Regeneration milestone reminder for standard unit \"E, F\"", result.get(3).title());
    Assertions.assertEquals("Please update your forest cover.", result.get(3).description());
    Assertions.assertEquals(OpeningDetailsNotificationStatusEnum.INFO, result.get(3).status());
  }
