...
public class OpeningServiceIntegrationTest extends AbstractTestContainerIntegrationTest {
  ...
  void getOpeningStockingDetails_existingOpeningId_shouldSucceed() {
    ...
    Assertions.assertEquals("2005-01-24", dto.stocking().milestones().postHarvestDeclaredDate().toString(), "Post-harvest declared date should match");
    Assertions.assertEquals("2007-06-15", dto.stocking().milestones().regenDeclaredDate().toString(), "Regen declared date should match");
    Assertions.assertEquals(6, dto.stocking().milestones().regenOffsetYears(), "Regen offset years should match");
    Assertions.assertEquals("2010-01-19", dto.stocking().milestones().regenDueDate().toString(), "Regen due date should match");
    ...
    Assertions.assertEquals("2017-05-30", dto.stocking().milestones().freeGrowingDeclaredDate().toString(), "Free growing declared date should match");
    Assertions.assertEquals(14, dto.stocking().milestones().freeGrowingOffsetYears(), "Free growing offset years should match");
    Assertions.assertEquals("2018-01-19", dto.stocking().milestones().freeGrowingDueDate().toString(), "Free growing due date should match");
