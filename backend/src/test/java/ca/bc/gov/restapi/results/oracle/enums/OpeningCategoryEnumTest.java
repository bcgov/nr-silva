...
class OpeningCategoryEnumTest {
  ...
  private static Stream<Arguments> enumConversion() {
    return Stream.of(
        ...
        Arguments.of("EXCLU", "Openings excluded from Crown managed forests", OpeningCategoryEnum.EXCLU),
        Arguments.of("FFTFLTC", "Forest For Tomorrow - Forestry Licence to Cut", OpeningCategoryEnum.FFTFLTC),
        Arguments.of("FFTITSL", "Forest For Tomorrow - Innovative Timber Sale Licence", OpeningCategoryEnum.FFTITSL),
        Arguments.of("FTCF", "Forest Tenure - Site Plan under Community Forest", OpeningCategoryEnum.FTCF),
        Arguments.of("FTFSM", "Forest Tenure - Forest Stand Management FPC s.71", OpeningCategoryEnum.FTFSM),
        ...
        Arguments.of("FTMSL", "Forest Tenure Ministry Silviculture Liability", OpeningCategoryEnum.FTMSL),
        Arguments.of(
            "FTNOLVY",
        ...
        Arguments.of("FTSBF", "Forest Tenure - Small Business Forest Enterprise Program", OpeningCategoryEnum.FTSBF),
        Arguments.of("FTWL", "Forest Tenure - Woodlot: Site Plan", OpeningCategoryEnum.FTWL),
        Arguments.of("NDAML", "Natural Disturbance - area-based Major Licensee", OpeningCategoryEnum.NDAML),
        Arguments.of("NDCF", "Natural Disturbance - Community Forest", OpeningCategoryEnum.NDCF),
        Arguments.of("NDVML", "Natural Disturbance - volume-based Major Licensee", OpeningCategoryEnum.NDVML),
        Arguments.of("NDWL", "Natural Disturbance - Woodlot License", OpeningCategoryEnum.NDWL),
        Arguments.of("NREQ", "Areas where SP/SMP's are not required by law", OpeningCategoryEnum.NREQ),
        Arguments.of(
            "SPEX",
