...
/**
 * Integration test for ActivityService with Oracle database. Executes activity search integration
 * tests against the Oracle database.
 */
...
public class ActivityServiceOracleIntegrationTest extends AbstractActivityServiceIntegrationTest {}
