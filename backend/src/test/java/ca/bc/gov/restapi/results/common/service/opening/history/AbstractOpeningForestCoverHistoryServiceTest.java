...
@DisplayName("Unit Test | Opening Forest Cover History Service | Contract")
public abstract class AbstractOpeningForestCoverHistoryServiceTest<T extends OpeningForestCoverHistoryService> {
  @Mock
  protected ForestCoverRepository forestCoverRepository;

  protected OpeningForestCoverHistoryService openingForestCoverHistoryService;

  protected abstract T createService(ForestCoverRepository forestCoverRepository);

  @BeforeEach
  void setup() {
    openingForestCoverHistoryService = createService(forestCoverRepository);
  }
  ...
  void getOpeningForestCoverHistoryOverviewList_returnsCorrectOverviewList() {
    ...
    when(forestCoverRepository.findHistoryOverviewByOpeningId(openingId))
    ...
    verify(forestCoverRepository).findHistoryOverviewByOpeningId(openingId);
  }
  ...
  void getOpeningForestCoverList_returnsCorrectDtos() {
    ...
    when(forestCoverRepository.findHistoryByOpeningDetails(openingId, updateDate, null))
        .thenReturn(List.of(projection));
    when(forestCoverRepository.findHistoryByOpeningDetailsSpecies(10L, "S", archiveDate))
        .thenReturn(List.of());
    when(forestCoverRepository.findHistoryByOpeningDetailsSpecies(10L, "I", archiveDate))
        .thenReturn(List.of());
    ...
    verify(forestCoverRepository).findHistoryByOpeningDetails(openingId, updateDate, null);
    verify(forestCoverRepository).findHistoryByOpeningDetailsSpecies(10L, "S", archiveDate);
    verify(forestCoverRepository).findHistoryByOpeningDetailsSpecies(10L, "I", archiveDate);
  }
  ...
  void getOpeningForestCoverList_returnsEmptyList() {
    ...
    when(forestCoverRepository.findHistoryByOpeningDetails(openingId, updateDate, null)).thenReturn(List.of());
  ...
  void getDetails_returnsCorrectDetailsDto() {
    ...
    when(forestCoverRepository.findHistoryByOpeningDetailsPolygon(coverId, archiveDate))
    ...
    when(forestCoverRepository.findHistoryByOpeningDetailsUnmapped(coverId, archiveDate))
    ...
    when(forestCoverRepository.findHistoryByOpeningDetailsLayer(coverId, archiveDate))
        .thenReturn(List.of(layerProjection));

    when(forestCoverRepository.findHistoryByOpeningDetailsDetailedSpecies(2L, archiveDate))
        .thenReturn(List.of());
    when(forestCoverRepository.findHistoryByOpeningDetailsDamage(2L, archiveDate))
        .thenReturn(List.of());
    ...
    verify(forestCoverRepository).findHistoryByOpeningDetailsPolygon(coverId, archiveDate);
    verify(forestCoverRepository).findHistoryByOpeningDetailsUnmapped(coverId, archiveDate);
    verify(forestCoverRepository).findHistoryByOpeningDetailsLayer(coverId, archiveDate);
    verify(forestCoverRepository).findHistoryByOpeningDetailsDetailedSpecies(2L, archiveDate);
    verify(forestCoverRepository).findHistoryByOpeningDetailsDamage(2L, archiveDate);
  }
