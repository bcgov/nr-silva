...
class StockingStandardEndpointTest {
  ...
  void createStockingStandard_delegatesToService() {
    CreateStockingStandardService service = mock(CreateStockingStandardService.class);
    StockingStandardEndpoint endpoint = new StockingStandardEndpoint(service);
    CreateStockingStandardRequestDto request = mock(CreateStockingStandardRequestDto.class);
