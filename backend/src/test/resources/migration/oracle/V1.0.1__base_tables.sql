...
CREATE TABLE THE.STOCKING_STANDARD_UNIT_ARCHIVE (
	...
	CONSTRAINT SYS_C008698 CHECK ("STOCKING_STANDARD_UNIT_ID" IS NOT NULL),
	CONSTRAINT SYS_C008699 CHECK ("STOCKING_EVENT_HISTORY_ID" IS NOT NULL),
	CONSTRAINT SYS_C008701 CHECK ("OPENING_ID" IS NOT NULL),
	CONSTRAINT SYS_C008703 CHECK ("STANDARDS_UNIT_ID" IS NOT NULL),
	CONSTRAINT SYS_C008705 CHECK ("NET_AREA" IS NOT NULL),
	CONSTRAINT SYS_C008707 CHECK ("REGEN_OBLIGATION_IND" IS NOT NULL),
	CONSTRAINT SYS_C008709 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT SYS_C008710 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C008711 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT SYS_C008712 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C008713 CHECK ("REVISION_COUNT" IS NOT NULL)
);
...
CREATE TABLE THE.STOCKING_ECOLOGY_ARCHIVE (
	...
	CONSTRAINT SYS_C008641 CHECK ("STOCKING_ECOLOGY_ID" IS NOT NULL),
	CONSTRAINT SYS_C008642 CHECK ("STOCKING_EVENT_HISTORY_ID" IS NOT NULL),
	CONSTRAINT SYS_C008643 CHECK ("STOCKING_STANDARD_UNIT_ID" IS NOT NULL),
	CONSTRAINT SYS_C008644 CHECK ("OPENING_ID" IS NOT NULL),
	CONSTRAINT SYS_C008645 CHECK ("REVISION_COUNT" IS NOT NULL),
	CONSTRAINT SYS_C008646 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT SYS_C008647 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C008648 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT SYS_C008649 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL)
);
...
CREATE TABLE THE.STOCKING_LAYER_ARCHIVE (
	...
	CONSTRAINT SYS_C008668 CHECK ("STOCKING_LAYER_ID" IS NOT NULL),
	CONSTRAINT SYS_C008669 CHECK ("STOCKING_EVENT_HISTORY_ID" IS NOT NULL),
	CONSTRAINT SYS_C008670 CHECK ("STOCKING_STANDARD_UNIT_ID" IS NOT NULL),
	CONSTRAINT SYS_C008671 CHECK ("OPENING_ID" IS NOT NULL),
	CONSTRAINT SYS_C008672 CHECK ("STOCKING_LAYER_CODE" IS NOT NULL),
	CONSTRAINT SYS_C008673 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT SYS_C008674 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C008675 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT SYS_C008676 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C008677 CHECK ("REVISION_COUNT" IS NOT NULL)
);
...
CREATE TABLE THE.STOCKING_LAYER_SPECIES_ARCHIVE (
	...
	CONSTRAINT SYS_C008731 CHECK ("STOCKING_LAYER_ID" IS NOT NULL),
	CONSTRAINT SYS_C008732 CHECK ("STOCKING_EVENT_HISTORY_ID" IS NOT NULL),
	CONSTRAINT SYS_C008733 CHECK ("STOCKING_STANDARD_UNIT_ID" IS NOT NULL),
	CONSTRAINT SYS_C008734 CHECK ("SPECIES_ORDER" IS NOT NULL),
	CONSTRAINT SYS_C008735 CHECK ("SILV_TREE_SPECIES_CODE" IS NOT NULL),
	CONSTRAINT SYS_C008736 CHECK ("PREFERRED_IND" IS NOT NULL),
	CONSTRAINT SYS_C008737 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT SYS_C008738 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C008739 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT SYS_C008740 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C008741 CHECK ("REVISION_COUNT" IS NOT NULL)
);
...
CREATE TABLE THE.FOREST_COVER_ARCHIVE (
	...
	CONSTRAINT SYS_C0028416 CHECK ("FOREST_COVER_ID" IS NOT NULL),
	CONSTRAINT SYS_C0028417 CHECK ("ARCHIVE_DATE" IS NOT NULL),
	CONSTRAINT SYS_C0028418 CHECK ("OPENING_ID" IS NOT NULL),
	CONSTRAINT SYS_C0028419 CHECK ("SILV_POLYGON_AREA" IS NOT NULL),
	CONSTRAINT SYS_C0028420 CHECK ("SILV_POLYGON_NET_AREA" IS NOT NULL),
	CONSTRAINT SYS_C0028421 CHECK ("REFERENCE_YEAR" IS NOT NULL),
	CONSTRAINT SYS_C0028422 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT SYS_C0028423 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C0028424 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT SYS_C0028425 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C0028426 CHECK ("REVISION_COUNT" IS NOT NULL)
);
...
CREATE TABLE THE.FOREST_COVER_ARCHIVE_GEOMETRY (
	...
	CONSTRAINT SYS_C0033476 CHECK ("FOREST_COVER_ID" IS NOT NULL),
	CONSTRAINT SYS_C0033477 CHECK ("ARCHIVE_DATE" IS NOT NULL),
	CONSTRAINT SYS_C0033478 CHECK ("FEATURE_AREA" IS NOT NULL),
	CONSTRAINT SYS_C0033479 CHECK ("FEATURE_PERIMETER" IS NOT NULL),
	CONSTRAINT SYS_C0033480 CHECK ("FEATURE_CLASS_SKEY" IS NOT NULL),
	CONSTRAINT SYS_C0033481 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT SYS_C0033482 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C0033483 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT SYS_C0033484 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C0033485 CHECK ("REVISION_COUNT" IS NOT NULL),
	CONSTRAINT SYS_C0033486 CHECK ("GEOMETRY" IS NOT NULL)
);
...
CREATE TABLE THE.FOREST_COVER_LAYER_ARCHIVE (
	...
	CONSTRAINT SYS_C009344 CHECK ("FOREST_COVER_ID" IS NOT NULL),
	CONSTRAINT SYS_C009345 CHECK ("FOREST_COVER_LAYER_ID" IS NOT NULL),
	CONSTRAINT SYS_C009346 CHECK ("ARCHIVE_DATE" IS NOT NULL),
	CONSTRAINT SYS_C009347 CHECK ("FOREST_COVER_LAYER_CODE" IS NOT NULL),
	CONSTRAINT SYS_C009348 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT SYS_C009349 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C009350 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT SYS_C009351 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C009352 CHECK ("REVISION_COUNT" IS NOT NULL)
);
...
CREATE TABLE THE.FOREST_COVER_LAYER_SPECIES_ARC (
	...
	CONSTRAINT SYS_C009277 CHECK ("FOREST_COVER_ID" IS NOT NULL),
	CONSTRAINT SYS_C009278 CHECK ("FOREST_COVER_LAYER_ID" IS NOT NULL),
	CONSTRAINT SYS_C009279 CHECK ("ARCHIVE_DATE" IS NOT NULL),
	CONSTRAINT SYS_C009280 CHECK ("SPECIES_ORDER" IS NOT NULL),
	CONSTRAINT SYS_C009281 CHECK ("TREE_SPECIES_CODE" IS NOT NULL),
	CONSTRAINT SYS_C009282 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT SYS_C009283 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C009284 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT SYS_C009285 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C009286 CHECK ("REVISION_COUNT" IS NOT NULL)
);
...
CREATE TABLE THE.FOREST_COVER_NON_MAPPED_ARC (
	...
	CONSTRAINT SYS_C0028479 CHECK ("FOREST_COVER_ID" IS NOT NULL),
	CONSTRAINT SYS_C0028480 CHECK ("NON_MAPPED_AREA_ID" IS NOT NULL),
	CONSTRAINT SYS_C0028481 CHECK ("ARCHIVE_DATE" IS NOT NULL),
	CONSTRAINT SYS_C0028482 CHECK ("NON_MAPPED_AREA" IS NOT NULL),
	CONSTRAINT SYS_C0028483 CHECK ("STOCKING_STATUS_CODE" IS NOT NULL),
	CONSTRAINT SYS_C0028484 CHECK ("REVISION_COUNT" IS NOT NULL)
);
...
CREATE TABLE THE.FORHEALTH_RSLT_ARCHIVE (
	...
	CONSTRAINT SYS_C0027107 CHECK ("ARCHIVE_DATE" IS NOT NULL),
	CONSTRAINT SYS_C0027108 CHECK ("FORHEALTH_RSLT_ID" IS NOT NULL),
	CONSTRAINT SYS_C0027109 CHECK ("SILV_DAMAGE_AGENT_CODE" IS NOT NULL),
	CONSTRAINT SYS_C0027110 CHECK ("ENTRY_USERID" IS NOT NULL),
	CONSTRAINT SYS_C0027111 CHECK ("ENTRY_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C0027112 CHECK ("UPDATE_USERID" IS NOT NULL),
	CONSTRAINT SYS_C0027113 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT SYS_C0027114 CHECK ("REVISION_COUNT" IS NOT NULL)
);
