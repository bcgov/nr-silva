...
CREATE TABLE THE.STANDARDS_REGIME_LAYER (
        STANDARDS_REGIME_LAYER_ID NUMBER(10,0) NOT NULL ENABLE,
        STANDARDS_REGIME_ID NUMBER(10,0) NOT NULL ENABLE,
        STOCKING_LAYER_CODE VARCHAR2(2) NOT NULL ENABLE,
        TREE_SIZE_UNIT_CODE VARCHAR2(3),
        RESIDUAL_BASAL_AREA NUMBER(5,0),
        MIN_HORIZONTAL_DISTANCE NUMBER(3,1),
        MIN_PREF_STOCKING_STANDARD NUMBER(5,0),
        ...
        UPDATE_TIMESTAMP DATE NOT NULL ENABLE,
        REVISION_COUNT NUMBER(5,0) NOT NULL ENABLE,
        CONSTRAINT SRL_PK PRIMARY KEY (STANDARDS_REGIME_LAYER_ID)
);
CREATE INDEX SRL_SR_FK_I ON THE.STANDARDS_REGIME_LAYER (STANDARDS_REGIME_ID);
CREATE INDEX SRL_SLC_FK_I ON THE.STANDARDS_REGIME_LAYER (STOCKING_LAYER_CODE);

CREATE TABLE THE.STANDARDS_REGIME_LAYER_SPECIES (
        STANDARDS_REGIME_LAYER_ID NUMBER(10,0) NOT NULL ENABLE,
        SILV_TREE_SPECIES_CODE VARCHAR2(8) NOT NULL ENABLE,
        SPECIES_ORDER NUMBER(5,0) NOT NULL ENABLE,
        PREFERRED_IND VARCHAR2(1) NOT NULL ENABLE,
        MIN_HEIGHT NUMBER(3,1),
        ENTRY_USERID VARCHAR2(30) NOT NULL ENABLE,
        ENTRY_TIMESTAMP DATE NOT NULL ENABLE,
        UPDATE_USERID VARCHAR2(30) NOT NULL ENABLE,
        UPDATE_TIMESTAMP DATE NOT NULL ENABLE,
        REVISION_COUNT NUMBER(5,0) NOT NULL ENABLE,
        CONSTRAINT SRLS_PK PRIMARY KEY (STANDARDS_REGIME_LAYER_ID, SILV_TREE_SPECIES_CODE)
);

CREATE TABLE THE.STANDARDS_REGIME_CLIENT (
        STANDARDS_REGIME_ID NUMBER(10,0) NOT NULL ENABLE,
        ...
        UPDATE_TIMESTAMP DATE NOT NULL ENABLE,
        REVISION_COUNT NUMBER(5,0) NOT NULL ENABLE,
        CONSTRAINT SRCLI_PK PRIMARY KEY (STANDARDS_REGIME_ID, CLIENT_NUMBER)
);
CREATE INDEX SRCLI_FC2_FK_I ON THE.STANDARDS_REGIME_CLIENT (CLIENT_NUMBER);

CREATE TABLE THE.STANDARDS_REGIME_ORG_UNIT (
        STANDARDS_REGIME_ID NUMBER(10,0) NOT NULL ENABLE,
        ORG_UNIT_NO NUMBER(10,0) NOT NULL ENABLE,
        ENTRY_USERID VARCHAR2(30) NOT NULL ENABLE,
        ENTRY_TIMESTAMP DATE NOT NULL ENABLE,
        ...
        UPDATE_TIMESTAMP DATE NOT NULL ENABLE,
        REVISION_COUNT NUMBER(5,0) NOT NULL ENABLE,
        CONSTRAINT SRORG_PK PRIMARY KEY (STANDARDS_REGIME_ID, ORG_UNIT_NO)
);
CREATE INDEX SRORG_OU_FK_I ON THE.STANDARDS_REGIME_ORG_UNIT (ORG_UNIT_NO);

CREATE TABLE THE.STANDARDS_REGIME_SITE_SERIES (
        STANDARD_REGIME_SITE_SERIES_ID NUMBER(10,0) NOT NULL ENABLE,
        STANDARDS_REGIME_ID NUMBER(10,0) NOT NULL ENABLE,
        BEC_REGION_CODE VARCHAR2(3),
        BGC_ZONE_CODE VARCHAR2(4),
        BGC_SUBZONE_CODE VARCHAR2(3),
        ...
        UPDATE_TIMESTAMP DATE NOT NULL ENABLE,
        REVISION_COUNT NUMBER(5,0) NOT NULL ENABLE,
        CONSTRAINT SRSS_PK PRIMARY KEY (STANDARD_REGIME_SITE_SERIES_ID)
);
CREATE INDEX SRSS_SR_FK_I ON THE.STANDARDS_REGIME_SITE_SERIES (STANDARDS_REGIME_ID);
