...
CREATE TABLE THE.SILV_COMMENT_TYPE_CODE (
	...
	CONSTRAINT SCTC_SYS_C008864 CHECK ("SILV_COMMENT_TYPE_CODE" IS NOT NULL),
	CONSTRAINT SCTC_SYS_C008865 CHECK ("DESCRIPTION" IS NOT NULL),
	CONSTRAINT SCTC_SYS_C008866 CHECK ("EFFECTIVE_DATE" IS NOT NULL),
	CONSTRAINT SCTC_SYS_C008867 CHECK ("EXPIRY_DATE" IS NOT NULL),
	CONSTRAINT SCTC_SYS_C008868 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL)
);
...
CREATE TABLE THE.SILV_COMMENT_SOURCE_CODE (
	...
	CONSTRAINT SCSC_SYS_C008895 CHECK ("SILV_COMMENT_SOURCE_CODE" IS NOT NULL),
	CONSTRAINT SCSC_SYS_C008900 CHECK ("DESCRIPTION" IS NOT NULL),
	CONSTRAINT SCSC_SYS_C008904 CHECK ("EFFECTIVE_DATE" IS NOT NULL),
	CONSTRAINT SCSC_SYS_C008909 CHECK ("EXPIRY_DATE" IS NOT NULL),
	CONSTRAINT SCSC_SYS_C008913 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL)
);

CREATE TABLE THE.FSP_STATUS_CODE (
	FSP_STATUS_CODE VARCHAR2(4),
	DESCRIPTION VARCHAR2(120),
	EFFECTIVE_DATE DATE,
	EXPIRY_DATE DATE,
	UPDATE_TIMESTAMP DATE,
	CONSTRAINT FSPSC_PK PRIMARY KEY (FSP_STATUS_CODE),
	CONSTRAINT FSC_C_SYS_C0017604 CHECK ("FSP_STATUS_CODE" IS NOT NULL),
	CONSTRAINT FSC_C_SYS_C0017605 CHECK ("DESCRIPTION" IS NOT NULL),
	CONSTRAINT FSC_C_SYS_C0017606 CHECK ("EFFECTIVE_DATE" IS NOT NULL),
	CONSTRAINT FSC_C_SYS_C0017607 CHECK ("EXPIRY_DATE" IS NOT NULL),
	CONSTRAINT FSC_C_SYS_C0017608 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL)
);

CREATE TABLE THE.STOCKING_LAYER_CODE (
	STOCKING_LAYER_CODE VARCHAR2(2),
	DESCRIPTION VARCHAR2(120),
	EFFECTIVE_DATE DATE,
	EXPIRY_DATE DATE,
	UPDATE_TIMESTAMP DATE,
	CONSTRAINT SLC_PK PRIMARY KEY (STOCKING_LAYER_CODE),
	CONSTRAINT SYS_C008292 CHECK ("STOCKING_LAYER_CODE" IS NOT NULL),
	CONSTRAINT SYS_C008293 CHECK ("DESCRIPTION" IS NOT NULL),
	CONSTRAINT SYS_C008294 CHECK ("EFFECTIVE_DATE" IS NOT NULL),
	CONSTRAINT SYS_C008295 CHECK ("EXPIRY_DATE" IS NOT NULL),
	CONSTRAINT SYS_C008296 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL)
);

CREATE TABLE THE.TREE_SIZE_UNIT_CODE (
	TREE_SIZE_UNIT_CODE VARCHAR2(3),
	DESCRIPTION VARCHAR2(120),
	EFFECTIVE_DATE DATE,
	EXPIRY_DATE DATE,
	UPDATE_TIMESTAMP DATE,
	CONSTRAINT SYS_C008179 CHECK ("TREE_SIZE_UNIT_CODE" IS NOT NULL),
	CONSTRAINT SYS_C008180 CHECK ("DESCRIPTION" IS NOT NULL),
	CONSTRAINT SYS_C008181 CHECK ("EFFECTIVE_DATE" IS NOT NULL),
	CONSTRAINT SYS_C008182 CHECK ("EXPIRY_DATE" IS NOT NULL),
	CONSTRAINT SYS_C008183 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL),
	CONSTRAINT TSUC_PK PRIMARY KEY (TREE_SIZE_UNIT_CODE)
);
...
CREATE TABLE THE.FOREST_COVER_LAYER_CODE (
	...
	EXPIRY_DATE DATE,
	UPDATE_TIMESTAMP DATE,
	CONSTRAINT FCLC_PK PRIMARY KEY (FOREST_COVER_LAYER_CODE),
	CONSTRAINT FCLC_C_SYS_C009323 CHECK ("FOREST_COVER_LAYER_CODE" IS NOT NULL),
	CONSTRAINT FCLC_C_SYS_C009324 CHECK ("DESCRIPTION" IS NOT NULL),
	CONSTRAINT FCLC_C_SYS_C009325 CHECK ("EFFECTIVE_DATE" IS NOT NULL),
	CONSTRAINT FCLC_C_SYS_C009326 CHECK ("EXPIRY_DATE" IS NOT NULL),
	CONSTRAINT FCLC_C_SYS_C009327 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL)
);
...
CREATE TABLE THE.SILV_DAMAGE_AGENT_CODE (
	...
	EXPIRY_DATE DATE,
	UPDATE_TIMESTAMP DATE,
	CONSTRAINT DAC_PK PRIMARY KEY (SILV_DAMAGE_AGENT_CODE),
	CONSTRAINT DAC_C_SYS_C008793 CHECK ("SILV_DAMAGE_AGENT_CODE" IS NOT NULL),
	CONSTRAINT DAC_C_SYS_C008794 CHECK ("DESCRIPTION" IS NOT NULL),
	CONSTRAINT DAC_C_SYS_C008795 CHECK ("EFFECTIVE_DATE" IS NOT NULL),
	CONSTRAINT DAC_C_SYS_C008796 CHECK ("EXPIRY_DATE" IS NOT NULL),
	CONSTRAINT DAC_C_SYS_C008797 CHECK ("UPDATE_TIMESTAMP" IS NOT NULL)
);
