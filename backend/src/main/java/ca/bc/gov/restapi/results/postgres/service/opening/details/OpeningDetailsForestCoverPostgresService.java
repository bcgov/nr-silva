...
@Service
public class OpeningDetailsForestCoverPostgresService extends
    AbstractOpeningDetailsForestCoverService {

  public OpeningDetailsForestCoverPostgresService(ForestCoverRepository coverRepository) {
