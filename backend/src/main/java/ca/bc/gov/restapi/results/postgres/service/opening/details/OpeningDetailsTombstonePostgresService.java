...
@Service
public class OpeningDetailsTombstonePostgresService extends AbstractOpeningDetailsTombstoneService {

  public OpeningDetailsTombstonePostgresService(OpeningRepository openingRepository,
