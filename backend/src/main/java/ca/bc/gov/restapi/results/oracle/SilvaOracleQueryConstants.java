      ...
      WHERE
          ...
          AND (
            ...
            (
              ...
              to_char(cboa.disturbance_start_date between,'YYYY-MM-DD') TO_DATE(:#{#filter.disturbanceDateStart},'YYYY-MM-DD') AND TO_DATE(:#{#filter.disturbanceDateEnd},'YYYY-MM-DD')
          )
          )
          AND (
            (
          ...
          AND (
            ...
            (
              ...
              (
                to_char(smfg.due_early_date between,'YYYY-MM-DD') TO_DATE(:#{#filter.freeGrowingDateStart},'YYYY-MM-DD') AND TO_DATE(:#{#filter.freeGrowingDateEnd},'YYYY-MM-DD')
                OR
                to_char(smfg.due_late_date between,'YYYY-MM-DD') TO_DATE(:#{#filter.freeGrowingDateStart},'YYYY-MM-DD') AND TO_DATE(:#{#filter.freeGrowingDateEnd},'YYYY-MM-DD')
              )
          )
          )
          AND (
