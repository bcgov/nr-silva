...
public class AbstractOpeningForestCoverHistoryService implements OpeningForestCoverHistoryService {
  ...
  @Override
  public List<OpeningForestCoverHistoryDto> getOpeningForestCoverList(Long openingId,
      String updateDate, String mainSearchTerm) {
  ...
  @Override
  public Optional<OpeningForestCoverHistoryDetailsDto> getDetails(Long coverId,
      String archiveDate) {
