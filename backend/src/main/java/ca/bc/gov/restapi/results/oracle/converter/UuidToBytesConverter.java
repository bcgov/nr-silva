...
/**
 * JPA attribute converter that converts between {@link UUID} and {@code byte[]} to support
 * storage of UUID values in Oracle databases using the {@code RAW(16)} column type.
 * <p>
 * This converter enables seamless conversion when persisting and retrieving UUID values
 * in entities annotated with {@link jakarta.persistence.Convert}.
 * <p>
 * Example usage:
 * <pre>
 * {@code
...
public class UuidToBytesConverter implements AttributeConverter<UUID, byte[]> {
     ...
     * @return the UUID representation of the byte array, or {@code null} if the input is null or not 16 bytes
     */
    @Override
