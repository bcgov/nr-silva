...
public interface ForestCoverEntityOracleRepository
  ...
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_LIST_SPECIES)
  ...
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_DETAILS_SPECIES)
  ...
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_HISTORY_OVERVIEW_LIST)
  List<ForestCoverHistoryOverviewProjection> findHistoryOverviewByOpeningId(Long openingId);

  @Override
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_HISTORY_LIST)
  ...
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_HISTORY_LIST_SPECIES)
  ...
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_HISTORY_POLYGON)
  ...
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_HISTORY_UNMAPPED)
  ...
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_HISTORY_LAYER)
  ...
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_HISTORY_DETAILS_SPECIES)
  ...
  @Query(
      nativeQuery = true,
      value = SilvaOracleQueryConstants.GET_OPENING_FOREST_COVER_HISTORY_DAMAGE)
