...
CREATE TABLE IF NOT EXISTS silva.spar_request (
	request_skey int8 NOT NULL,
	request_type_code varchar(3) NOT NULL,
	sowing_year int4 NOT NULL,
	request_year int4 NOT NULL,
	org_unit_no int8 NOT NULL,
	request_sequence int4 NOT NULL,
	spr_request_status_code varchar(3) NOT NULL,
	rqst_cli_number varchar(8) NULL,
	rqst_cli_locn_cd varchar(2) NULL,
	dist_admin_zone varchar(2) NULL,
	intended_use_code varchar(3) NULL,
	method_of_payment_code varchar(3) NULL,
	required_by_date timestamp(0) NULL,
	priority_date timestamp(0) NULL,
	authorization_code varchar(3) NULL,
	srvc_cli_number varchar(8) NULL,
	srvc_cli_locn_cd varchar(2) NULL,
	vegetation_code varchar(8) NULL,
	genetic_a_spz_code varchar(3) NULL,
	genetic_b_spz_code varchar(3) NULL,
	elevation_site_max int4 NULL,
	elevation_site_min int4 NULL,
	nad_datum_code varchar(2) NULL,
	utm_zone int4 NULL,
	utm_easting int8 NULL,
	utm_northing int8 NULL,
	latitude_degrees int4 NOT NULL,
	latitude_minutes int4 NOT NULL,
	latitude_seconds int4 NULL,
	longitude_degrees int4 NOT NULL,
	longitude_minutes int4 NOT NULL,
	longitude_seconds int4 NULL,
	seed_coast_area_code varchar(3) NULL,
	mapsheet_grid varchar(3) NULL,
	mapsheet_letter varchar(1) NULL,
	mapsheet_square varchar(3) NULL,
	mapsheet_quad varchar(1) NULL,
	mapsheet_sub_quad varchar(1) NULL,
	opening_number varchar(4) NULL,
	seedling_stock_type_code varchar(3) NULL,
	seedling_container_code varchar(4) NULL,
	seedling_stock_age_code varchar(6) NULL,
	planting_year int4 NULL,
	planting_day varchar(4) NULL,
	planting_season_code varchar(2) NULL,
	qty_seedlings_rqst numeric(6, 1) NOT NULL,
	lot_cli_number varchar(8) NULL,
	lot_cli_locn_cd varchar(2) NULL,
	lot_ownership_code varchar(1) NULL,
	crown_land_ind varchar(1) NULL,
	spar_request_regulation_code varchar(4) NULL,
	spr_tenure_code varchar(3) NULL,
	spar_fund_srce_code varchar(3) NULL,
	nursry_cli_number varchar(8) NULL,
	nursry_cli_locn_cd varchar(2) NULL,
	intended_use_locn varchar(30) NULL,
	authorized_by_prsn varchar(30) NULL,
	client_reference varchar(25) NULL,
	bgc_zone_code varchar(4) NULL,
	bgc_subzone_code varchar(3) NULL,
	variant varchar(1) NULL,
	opening_id int8 NULL,
	rqst_changed_ind varchar(1) NOT NULL,
	batch_job_id varchar(8) NULL,
	batch_update_ts timestamp(0) NULL,
	approved_userid varchar(30) NULL,
	approved_timestamp timestamp(0) NULL,
	request_comment varchar(2000) NULL,
	lot_crown_private_ind varchar(1) NULL,
	invoicing_exception_ind varchar(1) NOT NULL,
	invoicing_exception_comment varchar(2000) NULL,
	invoicing_exception_userid varchar(30) NULL,
	invoicing_exception_date timestamp(0) NULL,
	client_po_number varchar(10) NULL,
	field_contact_name varchar(40) NULL,
	field_contact_email_and_phone varchar(100) NULL,
	entry_userid varchar(30) NOT NULL,
	entry_timestamp timestamp(0) NOT NULL,
	update_userid varchar(30) NOT NULL,
	update_timestamp timestamp(0) NOT NULL,
	revision_count int4 NOT NULL,
	CONSTRAINT spar_request_pkey PRIMARY KEY (request_skey),
	CONSTRAINT spr_sr1_o_fk FOREIGN KEY (opening_id) REFERENCES silva.opening(opening_id)
);
CREATE UNIQUE INDEX IF NOT EXISTS "i1$_spar_request" ON silva.spar_request USING btree (request_type_code, sowing_year, request_year, org_unit_no, request_sequence);
CREATE INDEX IF NOT EXISTS "i4$_spar_request" ON silva.spar_request USING btree (sowing_year, org_unit_no, request_sequence);
CREATE INDEX IF NOT EXISTS "i7$_spar_request" ON silva.spar_request USING btree (org_unit_no);
CREATE INDEX IF NOT EXISTS "i8$_spar_request" ON silva.spar_request USING btree (spr_request_status_code, request_skey);
CREATE INDEX IF NOT EXISTS spr_sr1_o_fk_i ON silva.spar_request USING btree (opening_id);
COMMENT ON TABLE silva.spar_request IS 'A request for silviculture services from the Seed Planning and Registry (SPAR) system.';
