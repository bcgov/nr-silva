 ...
 * @returns {React.JSX.Element} A div element containing the chart container.
 */
function ChartContainer({ children, title, description, className }: Props): React.JSX.Element {
  return (
