...
5. **SonarCloud Quality Gate Audit:**
   ...
   - Note: This is an informational gate check. Do NOT dump hundreds of minor code smells into Fix-it Friday; record current Quality Gate status and active unresolved Blocker/Critical inventory (rather than treating historical items as new weekly regressions).
...
1. Fill out [fix-it-friday-issue-template.md](resources/fix-it-friday-issue-template.md) with the collected findings:
   ...
   - SonarCloud quality gates status and active unresolved blocker inventory.
